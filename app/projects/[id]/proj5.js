...
import photo from '../../../public/assign5.jpg'
    ...
    <div className={styles.moreProjects}>
      ...
      <div className={styles.desc}>
        ...
        <span className={styles.contentProject}>
          ...
          <span className={styles.contentRole}>Next.js</span>
          <span className={styles.contentClient}>
            <Link href='https://assignment5-javascript-frameworks.vercel.app/'>Link &#8600;</Link>
          </span>
          <span className={styles.contentSocial}>
            <Link href='https://github.com/jennynguyenoberg/assignment5-javascript-frameworks'>Link &#8600;</Link>
          </span>
        </span>
        {/* <span className={styles.bar}></span> */}
      </div>
